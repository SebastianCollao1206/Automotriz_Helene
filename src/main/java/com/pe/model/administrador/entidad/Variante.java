...
public class Variante implements Comparable<Variante>{
    public static final Comparator<Variante> VARIANTE_COMPARATOR_NATURAL_ORDER = Comparator.comparing(Variante::getCodigo);
...
//    }
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Variante variante)) return false;
        return Objects.equals(getCodigo(), variante.getCodigo());
    }
